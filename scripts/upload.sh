...
rom_upload() {
cd ~/
cd out/target/product/* && curl --upload-file ./crDroidAndroid-13.0-20240129-fleur-v9.13.zip https://transfer.sh/crDroidAndroid-13.0-20240129-fleur-v9.13.zip && curl --upload-file ./boot.img https://transfer.sh/boot.img
}
